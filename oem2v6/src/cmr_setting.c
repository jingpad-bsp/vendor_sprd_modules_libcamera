...
static cmr_int cmr_setting_parms_init() {
    ...
    cmr_add_cmd_fun_to_table(CAMERA_PARAM_VIDEO_FORMAT,
                             setting_set_video_format);
    cmr_add_cmd_fun_to_table(CAMERA_PARAM_YUV_CALLBACK_SIZE,
    ...
    cmr_add_cmd_fun_to_table(SETTING_GET_VIDEO_FORMAT,
                             setting_get_video_format);
    cmr_add_cmd_fun_to_table(SETTING_GET_YUV_CALLBACK_SIZE,
    ...
    cmr_add_cmd_fun_to_table(SETTING_GET_CNR, setting_get_cnr);
