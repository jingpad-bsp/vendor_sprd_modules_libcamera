 ...
 *
                                        still cameras: Exif Version 2.2" for
 more details.        *
 ******************************************************************************
...
typedef enum {
    ...
    IFD_JPEGINTERCHANGEFORMATLENGTH =
        0x202, // only used in IFD of thumbnail jpeg
    ...
    IFD_OFFSETTIME = 0x9010,
    IFD_OFFSETTIMEORIGINAL = 0x9011,
    IFD_OFFSETTIMEDIGITILIZED = 0x9012,
