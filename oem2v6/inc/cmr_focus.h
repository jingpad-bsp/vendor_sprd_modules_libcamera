...
enum focus_status_type { FOCUS_START = 0, FOCUS_NEED_QUIT, FOCUS_STATUS_MAX };
...
typedef void (*af_cb_func_ptr)(enum af_cb_type cb, cmr_uint parm,
                               void *privdata);
...
struct af_md_ops {
    ...
    cmr_int (*af_sensor_ioctrl)(cmr_handle oem_handle, cmr_uint cmd,
...
cmr_int cmr_focus_init(struct af_init_param *parm_ptr, cmr_u32 came_id_bits,
...
cmr_int cmr_focus_stop(cmr_handle af_handle, cmr_u32 came_id,
