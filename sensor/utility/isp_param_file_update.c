...
int update_param_v1(struct sensor_raw_info *sensor_raw_info_ptr,
    ...
    sprintf(mode_name[0], "static uint8_t s_%s_tune_info_common[]=",
            sensor_name);
    sprintf(mode_name[1], "static uint8_t s_%s_tune_info_prv_0[]=",
            sensor_name);
    sprintf(mode_name[2], "static uint8_t s_%s_tune_info_prv_1[]=",
            sensor_name);
    sprintf(mode_name[3], "static uint8_t s_%s_tune_info_prv_2[]=",
            sensor_name);
    sprintf(mode_name[4], "static uint8_t s_%s_tune_info_prv_3[]=",
            sensor_name);
    sprintf(mode_name[5], "static uint8_t s_%s_tune_info_cap_0[]=",
            sensor_name);
    sprintf(mode_name[6], "static uint8_t s_%s_tune_info_cap_1[]=",
            sensor_name);
    sprintf(mode_name[7], "static uint8_t s_%s_tune_info_cap_2[]=",
            sensor_name);
    sprintf(mode_name[8], "static uint8_t s_%s_tune_info_cap_3[]=",
            sensor_name);
    sprintf(mode_name[9], "static uint8_t s_%s_tune_info_video_0[]=",
            sensor_name);
    sprintf(mode_name[10], "static uint8_t s_%s_tune_info_video_1[]=",
            sensor_name);
    sprintf(mode_name[11], "static uint8_t s_%s_tune_info_video_2[]=",
            sensor_name);
    sprintf(mode_name[12], "static uint8_t s_%s_tune_info_video_3[]=",
            sensor_name);

    sprintf(mode_info_array,
            "static struct sensor_raw_info s_%s_mipi_raw_info=", sensor_name);

    sprintf(mode_info[0],
            "{s_%s_tune_info_common, sizeof(s_%s_tune_info_common)},",
            sensor_name, sensor_name);
    sprintf(mode_info[1],
            "{s_%s_tune_info_prv_0, sizeof(s_%s_tune_info_prv_0)},",
            sensor_name, sensor_name);
    sprintf(mode_info[2],
            "{s_%s_tune_info_prv_1, sizeof(s_%s_tune_info_prv_1)},",
            sensor_name, sensor_name);
    sprintf(mode_info[3],
            "{s_%s_tune_info_prv_2, sizeof(s_%s_tune_info_prv_2)},",
            sensor_name, sensor_name);
    sprintf(mode_info[4],
            "{s_%s_tune_info_prv_3, sizeof(s_%s_tune_info_prv_3)},",
            sensor_name, sensor_name);
    sprintf(mode_info[5],
            "{s_%s_tune_info_cap_0, sizeof(s_%s_tune_info_cap_0)},",
            sensor_name, sensor_name);
    sprintf(mode_info[6],
            "{s_%s_tune_info_cap_1, sizeof(s_%s_tune_info_cap_1)},",
            sensor_name, sensor_name);
    sprintf(mode_info[7],
            "{s_%s_tune_info_cap_2, sizeof(s_%s_tune_info_cap_2)},",
            sensor_name, sensor_name);
    sprintf(mode_info[8],
            "{s_%s_tune_info_cap_3, sizeof(s_%s_tune_info_cap_3)},",
            sensor_name, sensor_name);
    sprintf(mode_info[9],
            "{s_%s_tune_info_video_0, sizeof(s_%s_tune_info_video_0)},",
            sensor_name, sensor_name);
    sprintf(mode_info[10],
            "{s_%s_tune_info_video_1, sizeof(s_%s_tune_info_video_1)},",
            sensor_name, sensor_name);
    sprintf(mode_info[11],
            "{s_%s_tune_info_video_2, sizeof(s_%s_tune_info_video_2)},",
            sensor_name, sensor_name);
    sprintf(mode_info[12],
            "{s_%s_tune_info_video_3, sizeof(s_%s_tune_info_video_3)},",
            sensor_name, sensor_name);
        ...
        if (strstr(line_buff, mode_name_prefix) != NULL) {
            for (i = 0; i < 16; i++) {
                if (strstr(line_buff, mode_name[i]) != NULL) {
                    read_mode(fp, sensor_raw_info_ptr->mode_ptr[i].addr,
...
int read_ae_table_16bit(FILE *fp, uint16_t *data_ptr, uint32_t *data_len) {
    ...
    while (!feof(fp)) {
        ...
        n = sscanf(line_buf, "%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x",
                   ...
                   &c2[7], &c2[8], &c2[9], &c2[10], &c2[11], &c2[12], &c2[13],
                   &c2[14], &c2[15]);
...
int read_ae_scene_info(FILE *fp, struct sensor_ae_tab *ae_ptr, int scene_mode) {
    ...
    ae_ptr->scene_tab[scene_mode][0].scene_info_len =
        (long)param_buf - (long)(ae_ptr->scene_tab[scene_mode][0].scene_info);
    ae_ptr->scene_tab[scene_mode][1].scene_info_len =
        (long)param_buf - (long)(ae_ptr->scene_tab[scene_mode][1].scene_info);
...
int read_fix_ae_info(FILE *fp, struct sensor_ae_tab *ae_ptr) {
    ...
    unsigned char *line_buf =
        (unsigned char *)malloc(512 * sizeof(unsigned char));
    if (NULL == line_buf) {
    ...
    while (!feof(fp)) {
        ...
        if (strstr(line_buf, "_ae_tab_") != NULL &&
            strstr(line_buf, "_scene_ae_tab_") == NULL) {
            for (i = 0; i < AE_FLICKER_NUM; i++) {
                ...
                for (j = 0; j < AE_ISO_NUM_NEW; j++) {
                    ...
                    if ((strstr(line_buf, "static uint32_t") != NULL) &&
                        (strstr(line_buf, ae_tab_info[0]) != NULL)) {
                        rtn = read_ae_table_32bit(
                            fp, ae_ptr->ae_tab[i][j].index,
                            &ae_ptr->ae_tab[i][j].index_len);
                        if (0x00 != rtn) {
                            goto exit;
                        }
                        break_flag = 1;
                    ...
                    if ((strstr(line_buf, "static uint32_t") != NULL) &&
                        (strstr(line_buf, ae_tab_info[1]) != NULL)) {
                        rtn = read_ae_table_32bit(
                            fp, ae_ptr->ae_tab[i][j].exposure,
                            &ae_ptr->ae_tab[i][j].exposure_len);
                        if (0x00 != rtn) {
                            goto exit;
                        }
                        break_flag = 1;
                    ...
                    if ((strstr(line_buf, "static uint32_t") != NULL) &&
                        (strstr(line_buf, ae_tab_info[2]) != NULL)) {
                        rtn = read_ae_table_32bit(
                            fp, ae_ptr->ae_tab[i][j].dummy,
                            &ae_ptr->ae_tab[i][j].dummy_len);
                        if (0x00 != rtn) {
                            goto exit;
                        }
                        break_flag = 1;
                    ...
                    if ((strstr(line_buf, "static uint16_t") != NULL) &&
                        (strstr(line_buf, ae_tab_info[3]) != NULL)) {
                        rtn = read_ae_table_16bit(
                            fp, ae_ptr->ae_tab[i][j].again,
                            &ae_ptr->ae_tab[i][j].again_len);
                        if (0x00 != rtn) {
                            goto exit;
                        }
                        break_flag = 1;
                    ...
                    if ((strstr(line_buf, "static uint16_t") != NULL) &&
                        (strstr(line_buf, ae_tab_info[4]) != NULL)) {
                        rtn = read_ae_table_16bit(
                            fp, ae_ptr->ae_tab[i][j].dgain,
                            &ae_ptr->ae_tab[i][j].dgain_len);
                        if (0x00 != rtn) {
                            goto exit;
                        }
                        break_flag = 1;
        ...
        if (strstr(line_buf, "_ae_weight_") != NULL) {
            for (i = 0; i < AE_WEIGHT_TABLE_NUM; i++) {
                ...
                if ((strstr(line_buf, "static uint8_t") != NULL) &&
                    (strstr(line_buf, ae_weight_info) != NULL)) {
                    rtn = read_ae_weight(fp, &ae_ptr->weight_tab[i]);
                    break;
                }
            }
        }
        if (strstr(line_buf, "_scene_") != NULL &&
            (strstr(line_buf, "static uint32_t") != NULL ||
             strstr(line_buf, "static uint16_t") != NULL)) {
            for (i = 0; i < AE_SCENE_NUM; i++) {
                ...
                for (j = 0; j < AE_FLICKER_NUM; j++) {
                    ...
                    sprintf(ae_scene_info[2], "_scene_ae_tab_exposure_%d%d", i,
                            j);
                    ...
                    if ((strstr(line_buf, "static uint32_t") != NULL) &&
                        (strstr(line_buf, ae_scene_info[1]) != NULL)) {
                        rtn = read_ae_table_32bit(
                            fp, ae_ptr->scene_tab[i][j].index,
                            &ae_ptr->scene_tab[i][j].index_len);
                        if (0x00 != rtn) {
                            goto exit;
                        }
                        break_flag = 1;
                    ...
                    if ((strstr(line_buf, "static uint32_t") != NULL) &&
                        (strstr(line_buf, ae_scene_info[2]) != NULL)) {
                        rtn = read_ae_table_32bit(
                            fp, ae_ptr->scene_tab[i][j].exposure,
                            &ae_ptr->scene_tab[i][j].exposure_len);
                        if (0x00 != rtn) {
                            goto exit;
                        }
                        break_flag = 1;
                    ...
                    if ((strstr(line_buf, "static uint32_t") != NULL) &&
                        (strstr(line_buf, ae_scene_info[3]) != NULL)) {
                        rtn = read_ae_table_32bit(
                            fp, ae_ptr->scene_tab[i][j].dummy,
                            &ae_ptr->scene_tab[i][j].dummy_len);
                        if (0x00 != rtn) {
                            goto exit;
                        }
                        break_flag = 1;
                    ...
                    if ((strstr(line_buf, "static uint16_t") != NULL) &&
                        (strstr(line_buf, ae_scene_info[4]) != NULL)) {
                        rtn = read_ae_table_16bit(
                            fp, ae_ptr->scene_tab[i][j].again,
                            &ae_ptr->scene_tab[i][j].again_len);
                        if (0x00 != rtn) {
                            goto exit;
                        }
                        break_flag = 1;
                    ...
                    if ((strstr(line_buf, "static uint16_t") != NULL) &&
                        (strstr(line_buf, ae_scene_info[5]) != NULL)) {
                        rtn = read_ae_table_16bit(
                            fp, ae_ptr->scene_tab[i][j].dgain,
                            &ae_ptr->scene_tab[i][j].dgain_len);
                        if (0x00 != rtn) {
                            goto exit;
                        }
                        break_flag = 1;
        ...
        if (strstr(line_buf, "_ae_auto_iso_") != NULL) {
            for (i = 0; i < AE_FLICKER_NUM; i++) {
                ...
                if ((strstr(line_buf, "static uint16_t") != NULL) &&
                    (strstr(line_buf, ae_auto_iso_info) != NULL)) {
...
int read_awb_width_height(FILE *fp, struct sensor_awb_weight *awb_weight_ptr) {
    ...
    awb_weight_ptr->size_param_len =
        (long)param_buf - (long)(awb_weight_ptr->size);
...
int read_fix_awb_info(FILE *fp, struct sensor_awb_map_weight_param *awb_ptr) {
    ...
    while (!feof(fp)) {
        ...
        if ((strstr(line_buf, "static uint16_t") != NULL) &&
            (strstr(line_buf, "_awb_win_map") != NULL)) {
        ...
        if ((strstr(line_buf, "static uint8_t") != NULL) &&
            (strstr(line_buf, "_awb_pos_weight") != NULL)) {
        ...
        if ((strstr(line_buf, "static uint16_t") != NULL) &&
            (strstr(line_buf, "_awb_pos_weight_width_height") != NULL)) {
    ...
    while (!feof(fp)) {
        ...
        if (NULL != strstr(line_buf, "_lnc_map_info")) {
            for (i = 0; i < LNC_MAP_NUM; i++) {
                ...
                if ((strstr(line_buf, "static uint32_t") != NULL) &&
                    (strstr(line_buf, lnc_map_info) != NULL)) {
        ...
        if (NULL == strstr(line_buf, "_lnc_map_info") &&
            NULL != strstr(line_buf, "_lnc_")) {
            for (i = 0; i < LNC_MAP_NUM; i++) {
                sprintf(lnc_info, "_lnc_0%d", i);
                if ((strstr(line_buf, "static uint16_t") != NULL) &&
                    (strstr(line_buf, lnc_info) != NULL)) {
...
int update_param_v2(struct sensor_raw_info *sensor_raw_ptr,
                    unsigned char *sensor_name) {
    int rtn = 0x00;
    ...
    for (i = 0; i < 14; i++) {
        ...
        while (!feof(fp)) {
            ...
            if (strstr(line_buf, tune_info) != NULL) {
                rtn = read_tune_info(fp, sensor_raw_ptr->mode_ptr[i].addr,
                                     &sensor_raw_ptr->mode_ptr[i].len);
                if (0x00 != rtn) {
            ...
            if (strstr(line_buf, fixname) != NULL &&
                strstr(line_buf, "ae_param_info") != NULL) {
            ...
            if (strstr(line_buf, fixname) != NULL &&
                strstr(line_buf, "awb_param_info") != NULL) {
            ...
            if (strstr(line_buf, fixname) != NULL &&
                strstr(line_buf, "lnc_param_info") != NULL) {
            ...
            if (NULL != strstr(line_buf, note_name) &&
                NULL != strstr(line_buf, "_tool_ui_input")) {
                break;
            }
        }
        fclose(fp);
