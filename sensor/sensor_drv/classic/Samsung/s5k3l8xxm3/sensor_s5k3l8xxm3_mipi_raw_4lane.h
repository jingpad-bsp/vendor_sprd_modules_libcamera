...
static const SENSOR_REG_T s5k3l8xxm3_720p_setting[] = {
    // 720p setting @30fps, 24Mclk,p566.4M,1124M/lane,4lanes
    {0x6028, 0x2000}, {0x602A, 0x0F74}, {0x6F12, 0x0040}, {0x6F12, 0x0040},
    ...
    {0x0136, 0x1800}, {0x0304, 0x0006}, {0x0306, 0x00B1}, {0x0302, 0x0001},
    {0x0300, 0x0005}, {0x030C, 0x0006}, {0x030E, 0x0119}, {0x030A, 0x0001},
    {0x0308, 0x0008}, {0x0342, 0x16B0}, {0x0340, 0x0CAF}, {0x0202, 0x0200},
    {0x0200, 0x00C6}, {0x0B04, 0x0101}, {0x0B08, 0x0000}, {0x0B00, 0x0007},
    {0x316A, 0x00A0},

};

static const SENSOR_REG_T s5k3l8xxm3_video_setting[] = {
...
static struct sensor_res_tab_info s_s5k3l8xxm3_resolution_tab_raw[VENDOR_NUM] =
    {
        {.module_id = MODULE_SUNNY,
         .reg_tab = {{ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3_init_setting), PNULL, 0,
                      .width = 0, .height = 0, .xclk_to_sensor = EX_MCLK,
                      .image_format = SENSOR_IMAGE_FORMAT_RAW},

                     {ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3_video_setting), PNULL, 0,
                     ...
                     {ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3_preview_setting), PNULL,
                      0, .width = PREVIEW_WIDTH, .height = PREVIEW_HEIGHT,
                      .xclk_to_sensor = EX_MCLK,
                      .image_format = SENSOR_IMAGE_FORMAT_RAW},

                     {ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3_snapshot_setting), PNULL,
...
static SENSOR_TRIM_T
    s_s5k3l8xxm3_resolution_trim_tab[VENDOR_NUM] =
        {
            {.module_id = MODULE_SUNNY,
             .trim_info =
                 {
...
static SENSOR_REG_T s5k3l8xxm3_shutter_reg[] = {
...
static SENSOR_REG_T s5k3l8xxm3_again_reg[] = {
...
static SENSOR_REG_T s5k3l8xxm3_dgain_reg[] = {

};

static struct sensor_i2c_reg_tab s5k3l8xxm3_dgain_tab = {
    .settings = s5k3l8xxm3_dgain_reg, .size = ARRAY_SIZE(s5k3l8xxm3_dgain_reg),
};

static SENSOR_REG_T s5k3l8xxm3_frame_length_reg[] = {
...
SENSOR_INFO_T g_s5k3l8xxm3_mipi_raw_info = {
    ...
    .identify_count = 1,
    .identify_code = {{.reg_addr = s5k3l8xxm3_PID_ADDR,
                       .reg_value = s5k3l8xxm3_PID_VALUE},
                      {.reg_addr = s5k3l8xxm3_VER_ADDR,
                       .reg_value = s5k3l8xxm3_VER_VALUE}},
    ...
    .module_info_tab = s_s5k3l8xxm3_module_info_tab,
    .module_info_tab_size = ARRAY_SIZE(s_s5k3l8xxm3_module_info_tab),
