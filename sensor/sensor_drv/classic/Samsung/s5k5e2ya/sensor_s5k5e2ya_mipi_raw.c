 ...
 *
 *============================================================================*/
static cmr_int s5k5e2ya_drv_set_video_mode(cmr_handle handle, cmr_u32 param) {
...
static cmr_u32 s5k5e2ya_drv_get_static_info(cmr_handle handle, cmr_u32 *param) {
    cmr_u32 rtn = SENSOR_SUCCESS;
...
static cmr_u32 s5k5e2ya_drv_get_fps_info(cmr_handle handle, cmr_u32 *param) {
    cmr_u32 rtn = SENSOR_SUCCESS;
 ...
 *============================================================================*/
static cmr_u16 s5k5e2ya_drv_update_exposure(cmr_handle handle, cmr_u32 shutter,
                                            cmr_u32 dummy_line) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e2ya_drv_access_val(cmr_handle handle, unsigned long param) {
    cmr_int ret = SENSOR_FAIL;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e2ya_drv_init_exif_info(cmr_handle handle,
...
static cmr_int s5k5e2ya_drv_identify(cmr_handle handle, cmr_uint param) {
    ...
    if (s5k5e2ya_PID_VALUE == pid_value) {
        ver_value =
            hw_sensor_read_reg(sns_drv_cxt->hw_handle, s5k5e2ya_VER_ADDR);
 ...
 *============================================================================*/
static cmr_u32 s5k5e2ya_drv_before_snapshot(cmr_handle handle, cmr_uint param) {
 ...
 *============================================================================*/
static cmr_int s5k5e2ya_drv_write_exposure(cmr_handle handle, cmr_uint param) {
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int s5k5e2ya_drv_write_gain_value(cmr_handle handle, cmr_u32 param) {
    cmr_int ret_value = SENSOR_SUCCESS;
    float real_gain = 0;
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int s5k5e2ya_drv_set_hdr_ev(cmr_handle handle, cmr_uint param) {
 ...
 *sensor_drv_u.h
 *============================================================================*/
static cmr_int s5k5e2ya_drv_ext_func(cmr_handle handle, cmr_uint param) {
...
static cmr_int
s5k5e2ya_drv_handle_create(struct sensor_ic_drv_init_para *init_param,
...
static cmr_int s5k5e2ya_drv_get_private_data(cmr_handle handle, cmr_uint cmd,
                                             void **param) {
    cmr_int ret = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
