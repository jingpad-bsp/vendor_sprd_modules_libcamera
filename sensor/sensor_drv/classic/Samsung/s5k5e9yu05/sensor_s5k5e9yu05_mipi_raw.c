...
*
*/
#include "sensor_s5k5e9yu05_mipi_raw.h"

#define LOG_TAG "s5k5e9yu05_mipi_raw"

#define MIPI_RAW_INFO g_s5k5e9yu05_mipi_raw_info
#define RES_TRIM_TAB s_s5k5e9yu05_resolution_trim_tab
#define FPS_INFO s_s5k5e9yu05_mode_fps_info
#define STATIC_INFO s_s5k5e9yu05_static_info
#define VIDEO_INFO s_s5k5e9yu05_video_info
#define MODULE_INFO s_s5k5e9yu05_module_info_tab
#define RES_TAB_RAW s_s5k5e9yu05_resolution_tab_raw
 ...
 *
 *============================================================================*/
static cmr_int s5k5e9yu05_drv_set_video_mode(cmr_handle handle, cmr_u32 param) {
 ...
 *============================================================================*/
static cmr_u32 s5k5e9yu05_drv_init_fps_info(cmr_handle handle) {
...
static cmr_u32 s5k5e9yu05_drv_get_static_info(cmr_handle handle,
                                              cmr_u32 *param) {
    cmr_u32 rtn = SENSOR_SUCCESS;
    ...
    if (!fps_info->is_init) {
        s5k5e9yu05_drv_init_fps_info(handle);
    }
...
static cmr_u32 s5k5e9yu05_drv_get_fps_info(cmr_handle handle, cmr_u32 *param) {
    cmr_u32 rtn = SENSOR_SUCCESS;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k5e9yu05_drv_group_hold_on(cmr_handle handle) {
    SENSOR_LOGI("E");
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k5e9yu05_drv_group_hold_off(cmr_handle handle) {
    SENSOR_LOGI("E");
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u16 s5k5e9yu05_drv_read_gain(cmr_handle handle) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k5e9yu05_drv_write_gain(cmr_handle handle, float gain) {
...
#if 0
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x020e, (int)d_gain >> 8 & 0xff);
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x020f, (int)d_gain & 0xff);
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x0210, (int)d_gain >> 8 & 0xff);
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x0211, (int)d_gain & 0xff);
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x0212, (int)d_gain >> 8 & 0xff);
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x0213, (int)d_gain & 0xff);
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x0214, (int)d_gain >> 8 & 0xff);
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x0215, (int)d_gain & 0xff);
#endif
    // s5k5e9yu05_drv_group_hold_off();
}
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u16 s5k5e9yu05_drv_read_frame_length(cmr_handle handle) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k5e9yu05_drv_write_frame_length(cmr_handle handle,
                                              cmr_u32 frame_len) {
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u32 s5k5e9yu05_drv_read_shutter(cmr_handle handle) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void s5k5e9yu05_drv_write_shutter(cmr_handle handle, cmr_u32 shutter) {
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 *============================================================================*/
static cmr_u16 s5k5e9yu05_drv_update_exposure(cmr_handle handle,
                                              cmr_u32 shutter,
                                              cmr_u32 dummy_line) {
    ...
    cur_fr_len = s5k5e9yu05_drv_read_frame_length(handle);

    if (shutter < SENSOR_MIN_SHUTTER)
        shutter = SENSOR_MIN_SHUTTER;

    if (dest_fr_len != cur_fr_len)
        s5k5e9yu05_drv_write_frame_length(handle, dest_fr_len);
write_sensor_shutter:
    /* write shutter to sensor registers */
    s5k5e9yu05_drv_write_shutter(handle, shutter);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e9yu05_drv_power_on(cmr_handle handle, cmr_uint power_on) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    struct module_cfg_info *module_info = sns_drv_cxt->module_info;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e9yu05_drv_access_val(cmr_handle handle,
                                         unsigned long param) {
    cmr_int ret = SENSOR_FAIL;
    ...
    case SENSOR_VAL_TYPE_SHUTTER:
        *((cmr_u32 *)param_ptr->pval) = s5k5e9yu05_drv_read_shutter(handle);
        break;
    case SENSOR_VAL_TYPE_READ_OTP_GAIN:
        *((cmr_u32 *)param_ptr->pval) = s5k5e9yu05_drv_read_gain(handle);
        break;
    case SENSOR_VAL_TYPE_GET_STATIC_INFO:
        ret = s5k5e9yu05_drv_get_static_info(handle, param_ptr->pval);
        break;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e9yu05_drv_init_exif_info(cmr_handle handle,
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e9yu05_drv_identify(cmr_handle handle, cmr_uint param) {
    ...
    pid_value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, s5k5e9yu05_PID_ADDR);
    if (s5k5e9yu05_PID_VALUE == pid_value) {
        ver_value =
            hw_sensor_read_reg(sns_drv_cxt->hw_handle, s5k5e9yu05_VER_ADDR);
        SENSOR_LOGI("Identify: PID = %x, VER = %x", pid_value, ver_value);
        if (s5k5e9yu05_VER_VALUE == ver_value) {
            SENSOR_LOGI("this is s5k5e9yu05 sensor");
            // s5k5e9yu05_drv_init_exif_info();
 ...
 *============================================================================*/
static cmr_u32 s5k5e9yu05_drv_before_snapshot(cmr_handle handle,
                                              cmr_uint param) {
 ...
 *============================================================================*/
static cmr_int s5k5e9yu05_drv_write_exposure(cmr_handle handle,
                                             cmr_uint param) {
    ...
    sns_drv_cxt->sensor_ev_info.preview_shutter =
        s5k5e9yu05_drv_update_exposure(handle, exposure_line, dummy_line);
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int s5k5e9yu05_drv_write_gain_value(cmr_handle handle,
                                               cmr_u32 param) {
    cmr_int ret_value = SENSOR_SUCCESS;
    float real_gain = 0;
    SENSOR_IC_CHECK_HANDLE(handle);
    ...
    s5k5e9yu05_drv_write_gain(handle, real_gain);
 ...
 *
 *============================================================================*/
static void s5k5e9yu05_drv_increase_hdr_exposure(cmr_handle handle,
 ...
 *
 *============================================================================*/
static void s5k5e9yu05_drv_decrease_hdr_exposure(cmr_handle handle,
                                                 cmr_u8 ev_divisor) {
    ...
    if (gain_multiply >= ev_divisor) {
        s5k5e9yu05_drv_update_exposure(handle, hdr_info->capture_shutter, 0);
        s5k5e9yu05_drv_write_gain(handle, hdr_info->capture_gain / ev_divisor);

    } else {
        shutter = hdr_info->capture_shutter * gain_multiply / ev_divisor;
        s5k5e9yu05_drv_update_exposure(handle, shutter, 0);
        s5k5e9yu05_drv_write_gain(handle,
                                  hdr_info->capture_gain / gain_multiply);
    }
}
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int s5k5e9yu05_drv_set_hdr_ev(cmr_handle handle, cmr_uint param) {
    ...
    case SENSOR_HDR_EV_LEVE_0:
        ev_divisor = 2;
        s5k5e9yu05_drv_decrease_hdr_exposure(handle, ev_divisor);
        break;
    case SENSOR_HDR_EV_LEVE_1:
        ev_multiplier = 1;
        s5k5e9yu05_drv_increase_hdr_exposure(handle, ev_multiplier);
        break;
 ...
 *sensor_drv_u.h
 *============================================================================*/
static cmr_int s5k5e9yu05_drv_ext_func(cmr_handle handle, cmr_uint param) {
    ...
    switch (ext_ptr->cmd) {
    case SENSOR_EXT_EV:
        rtn = s5k5e9yu05_drv_set_hdr_ev(handle, param);
        break;
    default:
        break;
    }
...
static void s5k5e9yu05_calc_gain(float gain,
    ...
    if ((cmr_u32)real_gain <= 16 * 32) {
        ...
        a_gain = 16 * 32;
        d_gain = 256.0 * real_gain / a_gain;
        SENSOR_LOGI("_s5k5e9yu05: real_gain:0x%x, a_gain: 0x%x, d_gain: 0x%x",
                    (cmr_u32)real_gain, (cmr_u32)a_gain, (cmr_u32)d_gain);
        if ((cmr_u32)d_gain > 256 * 256)
            d_gain = 256 * 256; // d_gain < 256x
    }

    aec_info->again->settings[0].reg_value = ((cmr_u16)a_gain >> 8) & 0xff;
    aec_info->again->settings[1].reg_value = (cmr_u16)a_gain & 0xff;
...
static cmr_u16 s5k5e9yu05_read_frame_length(cmr_handle handle) {
    ...
    frame_len_h = hw_sensor_read_reg(sns_drv_cxt->hw_handle, 0x0340) & 0xff;
    frame_len_l = hw_sensor_read_reg(sns_drv_cxt->hw_handle, 0x0341) & 0xff;
    frame_length = (frame_len_h << 8) | frame_len_l;
...
static cmr_u16 s5k5e9yu05_calc_exposure(cmr_handle handle, cmr_u32 shutter,
    ...
    cur_fr_len = s5k5e9yu05_read_frame_length(handle);
...
static struct sensor_reg_tag s5k5e9yu05_shutter_reg[] = {
    {0x0202, 0}, {0x0203, 0},
};

static struct sensor_i2c_reg_tab s5k5e9yu05_shutter_tab = {
    .settings = s5k5e9yu05_shutter_reg,
    .size = ARRAY_SIZE(s5k5e9yu05_shutter_reg),
};

static struct sensor_reg_tag s5k5e9yu05_again_reg[] = {
    {0x0204, 0}, {0x0205, 0},
};

static struct sensor_i2c_reg_tab s5k5e9yu05_again_tab = {
    .settings = s5k5e9yu05_again_reg, .size = ARRAY_SIZE(s5k5e9yu05_again_reg),
};

static struct sensor_reg_tag s5k5e9yu05_dgain_reg[] = {
    {0x020e, 0}, {0x020f, 0}, {0x0210, 0}, {0x0211, 0},
    {0x0212, 0}, {0x0213, 0}, {0x0214, 0}, {0x0215, 0},
};

struct sensor_i2c_reg_tab s5k5e9yu05_dgain_tab = {
    .settings = s5k5e9yu05_dgain_reg, .size = ARRAY_SIZE(s5k5e9yu05_dgain_reg),
};

static struct sensor_reg_tag s5k5e9yu05_frame_length_reg[] = {
    {0x0340, 0}, {0x0341, 0},
};

static struct sensor_i2c_reg_tab s5k5e9yu05_frame_length_tab = {
    .settings = s5k5e9yu05_frame_length_reg,
    .size = ARRAY_SIZE(s5k5e9yu05_frame_length_reg),
};

static struct sensor_aec_i2c_tag s5k5e9yu05_aec_info = {
    .slave_addr = (I2C_SLAVE_ADDR >> 1),
    .addr_bits_type = SENSOR_I2C_REG_16BIT,
    .data_bits_type = SENSOR_I2C_VAL_8BIT,
    .shutter = &s5k5e9yu05_shutter_tab,
    .again = &s5k5e9yu05_again_tab,
    .dgain = &s5k5e9yu05_dgain_tab,
    .frame_length = &s5k5e9yu05_frame_length_tab,
};

static cmr_int s5k5e9yu05_read_aec_info(cmr_handle handle, void *param) {
    cmr_int ret = SENSOR_SUCCESS;
    ...
    info->aec_i2c_info_out = &s5k5e9yu05_aec_info;
    ...
    sns_drv_cxt->sensor_ev_info.preview_shutter = s5k5e9yu05_calc_exposure(
        handle, exposure_line, dummy_line, mode, &s5k5e9yu05_aec_info);

    gain = info->gain < SENSOR_BASE_GAIN ? SENSOR_BASE_GAIN : info->gain;
    real_gain = (float)info->gain * SENSOR_BASE_GAIN / ISP_BASE_GAIN * 1.0;
    s5k5e9yu05_calc_gain(real_gain, &s5k5e9yu05_aec_info);
    return ret;
}
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e9yu05_drv_stream_on(cmr_handle handle, cmr_u32 param) {
    SENSOR_LOGI("E");
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int s5k5e9yu05_stream_off(cmr_handle handle, cmr_u32 param) {
    SENSOR_LOGI("E");
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int
s5k5e9yu05_drv_handle_create(struct sensor_ic_drv_init_para *init_param,
    ...
    s5k5e9yu05_drv_init_exif_info(sns_drv_cxt, &sns_drv_cxt->exif_ptr);
...
static cmr_int s5k5e9yu05_drv_handle_delete(cmr_handle handle, cmr_int *param) {
    cmr_int ret = SENSOR_SUCCESS;
...
static cmr_int s5k5e9yu05_drv_get_private_data(cmr_handle handle, cmr_uint cmd,
                                               void **param) {
    cmr_int ret = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
 ...
 * .power = s5k5e9yu05_drv_power_on,
 *============================================================================*/
static struct sensor_ic_ops s5k5e9yu05_ops_tab = {
    .create_handle = s5k5e9yu05_drv_handle_create,
    .delete_handle = s5k5e9yu05_drv_handle_delete,
    .get_data = s5k5e9yu05_drv_get_private_data,

    .power = s5k5e9yu05_drv_power_on,
    .identify = s5k5e9yu05_drv_identify,
    .ex_write_exp = s5k5e9yu05_drv_write_exposure,
    .write_gain_value = s5k5e9yu05_drv_write_gain_value,
    .read_aec_info = s5k5e9yu05_read_aec_info,

    .ext_ops = {
            [SENSOR_IOCTL_EXT_FUNC].ops = s5k5e9yu05_drv_ext_func,
            [SENSOR_IOCTL_VIDEO_MODE].ops = s5k5e9yu05_drv_set_video_mode,
            [SENSOR_IOCTL_BEFORE_SNAPSHOT].ops = s5k5e9yu05_drv_before_snapshot,
            [SENSOR_IOCTL_STREAM_ON].ops = s5k5e9yu05_drv_stream_on,
            [SENSOR_IOCTL_STREAM_OFF].ops = s5k5e9yu05_stream_off,
            [SENSOR_IOCTL_ACCESS_VAL].ops = s5k5e9yu05_drv_access_val,
    }};
