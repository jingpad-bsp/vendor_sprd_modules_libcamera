...
#define LOG_TAG "ov8856_xl_4lane"
#include <utils/Log.h>
#include "sensor.h"
...
#include "sensor_ov8856_xl_otp.h"

#define VENDOR_NUM 1
#define SENSOR_NAME "ov8856_xl"
...
struct sensor_raw_info *s_ov8856_xl_mipi_raw_info_ptr = PNULL;
 ...
 *============================================================================*/
SENSOR_INFO_T g_ov8856_xl_mipi_raw_info = {
    ...
    .raw_info_ptr = &s_ov8856_xl_mipi_raw_info_ptr,
