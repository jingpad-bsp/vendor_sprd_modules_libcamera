...
static const struct pd_pos_info _ov13b10_pd_pos_r[] = {
    {10, 6}, {2, 10},
};

static const struct pd_pos_info _ov13b10_pd_pos_l[] = {
    {10, 2}, {2, 14},
};
...
static cmr_int ov13b10_drv_get_pdaf_info(cmr_handle handle, cmr_u32 *param) {
    cmr_int rtn = SENSOR_SUCCESS;
    ...
    pd_pos_is_right_size = NUMBER_OF_ARRAY(ov13b10_pd_is_right);
    pd_pos_row_size = NUMBER_OF_ARRAY(ov13b10_pd_row);
    pd_pos_col_size = NUMBER_OF_ARRAY(ov13b10_pd_col);
    ...
    pdaf_info->pd_is_right = (cmr_u16 *)ov13b10_pd_is_right;
    pdaf_info->pd_pos_row = (cmr_u16 *)ov13b10_pd_row;
    pdaf_info->pd_pos_col = (cmr_u16 *)ov13b10_pd_col;

    cmr_u16 pd_pos_r_size = NUMBER_OF_ARRAY(_ov13b10_pd_pos_r);
    cmr_u16 pd_pos_l_size = NUMBER_OF_ARRAY(_ov13b10_pd_pos_l);
    ...
    pdaf_info->pd_pos_r = (struct pd_pos_info *)_ov13b10_pd_pos_r;
    pdaf_info->pd_pos_l = (struct pd_pos_info *)_ov13b10_pd_pos_l;
...
// ov13b10_drv_set_slave_FrameSync(handle, param);
#endif
    /*TODO*/
