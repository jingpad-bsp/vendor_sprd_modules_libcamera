...
#define LOG_TAG "ov16e10" 

 #include "sensor_ov16e10_mipi_raw.h"
...
static void ov16e10_drv_write_reg2sensor(cmr_handle handle, struct sensor_i2c_reg_tab *reg_info)
{
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void ov16e10_drv_write_gain(cmr_handle handle, struct sensor_aec_i2c_tag *aec_info, cmr_u32 gain)
{
	...
	{
		/*TODO*/
	    aec_info->again->settings[1].reg_value = (gain >> 8) & 0xff;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void ov16e10_drv_write_frame_length(cmr_handle handle, struct sensor_aec_i2c_tag *aec_info, cmr_u32 frame_len)
{
    SENSOR_IC_CHECK_PTR_VOID(aec_info);
	SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_u32 ov16e10_drv_read_shutter(cmr_handle handle) {
    cmr_u32 value = 0x00;
   ...
   // hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0xfd, 0x01);
    shutter_m = hw_sensor_read_reg(sns_drv_cxt->hw_handle, 0x0e);
    shutter_h = hw_sensor_read_reg(sns_drv_cxt->hw_handle, 0x0f);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void ov16e10_drv_write_shutter(cmr_handle handle, struct sensor_aec_i2c_tag *aec_info , cmr_u32 shutter)
{
	SENSOR_IC_CHECK_PTR_VOID(aec_info);
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 *============================================================================*/
static void ov16e10_drv_calc_exposure(cmr_handle handle, cmr_u32 shutter, cmr_u32 dummy_line, 
                                                  cmr_u16 mode, cmr_u32 exp_time, struct sensor_aec_i2c_tag *aec_info)
{
    ...
    ov16e10_drv_write_frame_length(handle, aec_info, dest_fr_len);
    
    sns_drv_cxt->sensor_ev_info.preview_shutter = shutter;
	ov16e10_drv_write_shutter(handle, aec_info, shutter);

    sns_drv_cxt->sensor_ev_info.preview_exptime= exp_time;
    if(sns_drv_cxt->ops_cb.set_exif_info) {
        sns_drv_cxt->ops_cb.set_exif_info(sns_drv_cxt->caller_handle,
                          SENSOR_EXIF_CTRL_EXPOSURETIME_BYTIME, exp_time);
    }
}


static void ov16e10_drv_calc_gain(cmr_handle handle,cmr_uint isp_gain, struct sensor_aec_i2c_tag *aec_info) 
{
	SENSOR_IC_CHECK_HANDLE_VOID(handle);
	struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
	...
	ov16e10_drv_write_gain(handle, aec_info, sensor_gain);
}
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int ov16e10_drv_power_on(cmr_handle handle, cmr_uint power_on)
{
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    ...
    BOOLEAN power_down = g_ov16e10_mipi_raw_info.power_down_level;
    BOOLEAN reset_level = g_ov16e10_mipi_raw_info.reset_pulse_level;	
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int ov16e10_drv_init_fps_info(cmr_handle handle) 
{
...
static cmr_int ov16e10_drv_init_exif_info(cmr_handle handle, void **exif_info_in /*in*/) 
{
    cmr_int rtn = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int ov16e10_drv_get_static_info(cmr_handle handle, cmr_u32 *param) 
{
    cmr_int rtn = SENSOR_SUCCESS;
    ...
    if (!fps_info->is_init) {
        ov16e10_drv_init_fps_info(handle);
    }
    ...
    ex_info->name = (cmr_s8 *)g_ov16e10_mipi_raw_info.name;
    ex_info->sensor_version_info = (cmr_s8 *)g_ov16e10_mipi_raw_info.sensor_version_info;
...
static cmr_int ov16e10_drv_get_fps_info(cmr_handle handle, cmr_u32 *param) 
{
    cmr_int rtn = SENSOR_SUCCESS;
...
static const cmr_u16 ov16e10_pd_is_right[] = { 0, 1, 0, 1, 0, 1, 0, 1, };

static const cmr_u16 ov16e10_pd_row[] = { 2, 2, 2, 2, 10, 10, 10 ,10, };

static const cmr_u16 ov16e10_pd_col[] = { 5, 6, 13, 14, 1, 2, 9, 10, };

static const cmr_u32 pd_sns_mode[] = {0, 0, 0, 1};

struct pdaf_coordinate_tab ov16e10_pd_coordinate_table[] = {
    {.number = 4,
     .pos_info = {0, 1, 0, 1},
    },
    {.number = 4,
...
struct pdaf_block_descriptor ov16e10_pd_seprator_helper = {
    .block_width = 4,
    .block_height = 2,
    .coordinate_tab = NULL,
    .line_width = 4,
    .block_pattern = CROSS_PATTERN,
    .pd_line_coordinate = ov16e10_pd_coordinate_table,
};

static const struct pd_pos_info _ov16e10_pd_pos_l []={
    {5, 2}, {13, 2}, {1, 10}, {9, 10},
};
static const struct pd_pos_info _ov16e10_pd_pos_r []={
	{6, 2}, {14, 2}, {2, 10}, {10, 10},
};

cmr_int ov16e10_drv_pdaf_data_process(void *buffer_handle);

#define PDAF_BLOCK_SIZE_W 16
#define PDAF_BLOCK_SIZE_H 16

static cmr_int ov16e10_drv_get_pdaf_info(cmr_handle handle, cmr_u32 *param)
{
	cmr_int rtn = SENSOR_SUCCESS;
    ...
    pd_pos_is_right_size = NUMBER_OF_ARRAY(ov16e10_pd_is_right);
    pd_pos_row_size = NUMBER_OF_ARRAY(ov16e10_pd_row);
    pd_pos_col_size = NUMBER_OF_ARRAY(ov16e10_pd_col);
    ...
    pdaf_info->vch2_info.vch2_data_type = 0x19;
    pdaf_info->vch2_info.vch2_mode = 0x01;
    pdaf_info->pd_is_right = (cmr_u16 *)ov16e10_pd_is_right;
    pdaf_info->pd_pos_row = (cmr_u16 *)ov16e10_pd_row;
    pdaf_info->pd_pos_col = (cmr_u16 *)ov16e10_pd_col;
    pdaf_info->pd_pos_size = (pd_pos_is_right_size / 2);
    pdaf_info->pd_pos_r = (struct pd_pos_info *)_ov16e10_pd_pos_r;
    pdaf_info->pd_pos_l = (struct pd_pos_info *)_ov16e10_pd_pos_l;
    pdaf_info->sns_mode = pd_sns_mode;
    pdaf_info->vendor_type = SENSOR_VENDOR_OV16E1Q;
    pdaf_info->sns_orientation = 0; // 1: mirror+flip; 0: normal
    pdaf_info->descriptor = &ov16e10_pd_seprator_helper;

    pdaf_info->pd_data_size = pdaf_info->pd_block_num_x * pdaf_info->pd_block_num_y *
				NUMBER_OF_ARRAY(ov16e10_pd_is_right) * 5;
    pdaf_info->pdaf_format_converter = ov16e10_drv_pdaf_data_process;
...
cmr_int ov16e10_drv_pdaf_data_process(void *buffer_handle) {
	...
	ov16e10_drv_get_pdaf_info(NULL, (cmr_u32 *)(&pdaf_info));
	sensor_pdaf_format_convertor(buffer_handle,
			s_ov16e10_static_info[0].static_info.pdaf_supported,
			(cmr_u32 *)(&pdaf_info));
	return SENSOR_SUCCESS;
}
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int ov16e10_drv_access_val(cmr_handle handle, cmr_uint param)
{
	...
	SENSOR_LOGI("sensor ov16e10: param_ptr->type=%x", param_ptr->type);

	switch(param_ptr->type)
	{
		case SENSOR_VAL_TYPE_GET_STATIC_INFO:
			ret = ov16e10_drv_get_static_info(handle, param_ptr->pval);
			break;
		case SENSOR_VAL_TYPE_GET_FPS_INFO:
			ret = ov16e10_drv_get_fps_info(handle, param_ptr->pval);
			break;
		case SENSOR_VAL_TYPE_SET_SENSOR_CLOSE_FLAG:
			ret = sns_drv_cxt->is_sensor_close = 1;
			break;
		case SENSOR_VAL_TYPE_GET_PDAF_INFO:
			ret = ov16e10_drv_get_pdaf_info(handle, param_ptr->pval);
		      break;
		default:
			break;
    }
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int ov16e10_drv_identify(cmr_handle handle, cmr_uint param)
{
	...
	SENSOR_LOGE("mipi raw identify");

	pid_value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, ov16e10_PID_ADDR);

      SENSOR_LOGE("hui: pid_value = %x", pid_value);
	if (ov16e10_PID_VALUE == pid_value) {
		ver_value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, ov16e10_VER_ADDR);
		SENSOR_LOGE("Identify: pid_value = %x, ver_value = %x", pid_value, ver_value);
		if (ov16e10_VER_VALUE == ver_value) {
			SENSOR_LOGE("this is ov16e10 sensor");
 ...
 *============================================================================*/
static cmr_int ov16e10_drv_before_snapshot(cmr_handle handle, cmr_uint param)
{
    ...
    ov16e10_drv_calc_exposure(handle,cap_shutter, 0 , capture_mode,cap_exptime, &ov16e10_aec_info);
	ov16e10_drv_write_reg2sensor(handle, ov16e10_aec_info.frame_length);
	ov16e10_drv_write_reg2sensor(handle, ov16e10_aec_info.shutter);

	sns_drv_cxt->sensor_ev_info.preview_gain=cap_gain;
	ov16e10_drv_write_gain(handle, &ov16e10_aec_info, cap_gain);
	ov16e10_drv_write_reg2sensor(handle, ov16e10_aec_info.again);
	ov16e10_drv_write_reg2sensor(handle, ov16e10_aec_info.dgain);

snapshot_info:
    if(sns_drv_cxt->ops_cb.set_exif_info) {
        sns_drv_cxt->ops_cb.set_exif_info(sns_drv_cxt->caller_handle, SENSOR_EXIF_CTRL_EXPOSURETIME_BYTIME, cap_exptime);
    } else {
 ...
 *============================================================================*/
static cmr_int ov16e10_drv_write_exposure(cmr_handle handle, cmr_uint param)
{
	...
	ov16e10_drv_calc_exposure(handle,exposure_line, dummy_line, size_index,exp_time, &ov16e10_aec_info);
	ov16e10_drv_write_reg2sensor(handle, ov16e10_aec_info.frame_length);
	ov16e10_drv_write_reg2sensor(handle, ov16e10_aec_info.shutter);
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int ov16e10_drv_write_gain_value(cmr_handle handle, cmr_uint param)
{
	cmr_int ret_value = SENSOR_SUCCESS;
	...
	ov16e10_drv_calc_gain(handle,param, &ov16e10_aec_info);
	ov16e10_drv_write_reg2sensor(handle, ov16e10_aec_info.again);
	ov16e10_drv_write_reg2sensor(handle, ov16e10_aec_info.dgain);
 ...
 * please don't change this function unless it's necessary
 *============================================================================*/
static cmr_int ov16e10_drv_read_aec_info(cmr_handle handle, cmr_uint param)
{
    cmr_int ret_value = SENSOR_SUCCESS;
    ...
    info->aec_i2c_info_out = &ov16e10_aec_info;
    exposure_line = info->exp.exposure;
    dummy_line = info->exp.dummy;
    mode = info->exp.size_index;
    exp_time = info->exp.exp_time;

    ov16e10_drv_calc_exposure(handle, exposure_line, dummy_line, mode,exp_time, &ov16e10_aec_info);
    ov16e10_drv_calc_gain(handle,info->gain, &ov16e10_aec_info);

    return ret_value;
}

static cmr_int ov16e10_drv_set_master_FrameSync(cmr_handle handle, cmr_uint param)
{
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    ...
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x381e, 0x07);
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x381a, 0x16);
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x381b, 0xd0);
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x381c, 0x01);
    hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x301d, 0x6d);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int ov16e10_drv_stream_on(cmr_handle handle, cmr_uint param)
{
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    ...
    if(MODE_BOKEH == sns_drv_cxt->is_multi_mode) {
        ov16e10_drv_set_master_FrameSync(handle, param);
    }
#endif
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int ov16e10_drv_stream_off(cmr_handle handle, cmr_uint param)
{
	SENSOR_LOGI("E");
...
static cmr_int ov16e10_drv_handle_create(struct sensor_ic_drv_init_para *init_param, cmr_handle* sns_ic_drv_handle)
{
	...
	ov16e10_drv_write_frame_length(sns_drv_cxt, &ov16e10_aec_info, sns_drv_cxt->sensor_ev_info.preview_framelength);
	ov16e10_drv_write_gain(sns_drv_cxt, &ov16e10_aec_info, sns_drv_cxt->sensor_ev_info.preview_gain);
	ov16e10_drv_write_shutter(sns_drv_cxt, &ov16e10_aec_info, sns_drv_cxt->sensor_ev_info.preview_shutter);

    sensor_ic_set_match_module_info(sns_drv_cxt, ARRAY_SIZE(s_ov16e10_module_info_tab), s_ov16e10_module_info_tab);
    sensor_ic_set_match_resolution_info(sns_drv_cxt, ARRAY_SIZE(s_ov16e10_resolution_tab_raw), s_ov16e10_resolution_tab_raw);
    sensor_ic_set_match_trim_info(sns_drv_cxt, ARRAY_SIZE(s_ov16e10_resolution_trim_tab), s_ov16e10_resolution_trim_tab);
    sensor_ic_set_match_static_info(sns_drv_cxt, ARRAY_SIZE(s_ov16e10_static_info), s_ov16e10_static_info);
    sensor_ic_set_match_fps_info(sns_drv_cxt, ARRAY_SIZE(s_ov16e10_mode_fps_info), s_ov16e10_mode_fps_info);

    /*init exif info,this will be deleted in the future*/
    ov16e10_drv_init_fps_info(sns_drv_cxt);
	ov16e10_drv_init_exif_info(sns_drv_cxt, &sns_drv_cxt->exif_ptr);
...
static cmr_int ov16e10_drv_handle_delete(cmr_handle handle, void *param)
{
    cmr_int ret = SENSOR_SUCCESS;
...
{
     return &g_ov16e10_mipi_raw_info;
}
static cmr_int ov16e10_drv_get_private_data(cmr_handle handle, cmr_uint cmd, void**param)
{
    cmr_int ret = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
    SENSOR_IC_CHECK_PTR(param);
 ...
 * .power = ov16e10_power_on,
 *============================================================================*/
static struct sensor_ic_ops s_ov16e10_ops_tab = {
    .create_handle = ov16e10_drv_handle_create,
    .delete_handle = ov16e10_drv_handle_delete,
    /*get privage data*/
    .get_data = ov16e10_drv_get_private_data,
    /*common interface*/
	.power = ov16e10_drv_power_on,
	.identify = ov16e10_drv_identify,
	.ex_write_exp = ov16e10_drv_write_exposure,
	.write_gain_value = ov16e10_drv_write_gain_value,
#if defined(CONFIG_DUAL_MODULE)
	.read_aec_info = ov16e10_drv_read_aec_info,
#endif
    .ext_ops = {
        [SENSOR_IOCTL_BEFORE_SNAPSHOT].ops = ov16e10_drv_before_snapshot,
        [SENSOR_IOCTL_STREAM_ON].ops = ov16e10_drv_stream_on,
        [SENSOR_IOCTL_STREAM_OFF].ops = ov16e10_drv_stream_off,
        /* expand interface,if you want to add your sub cmd ,
         *  you can add it in enum {@SENSOR_IOCTL_VAL_TYPE}
         */
        [SENSOR_IOCTL_ACCESS_VAL].ops = ov16e10_drv_access_val,
    }
};
