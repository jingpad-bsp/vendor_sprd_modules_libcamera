...
static cmr_int ov16885_normal_drv_get_pdaf_info(cmr_handle handle, cmr_u32 *param)
{
    ...
    pd_pos_is_right_size = NUMBER_OF_ARRAY(ov16885_normal_pd_is_right);
    pd_pos_row_size = NUMBER_OF_ARRAY(ov16885_normal_pd_row);
    pd_pos_col_size = NUMBER_OF_ARRAY(ov16885_normal_pd_col);
    ...
    pdaf_info->pd_end_x = 4672;
    pdaf_info->pd_end_y = 3504;
    pdaf_info->pd_block_w = 1;
    pdaf_info->pd_block_h = 1;
    pdaf_info->pd_block_num_x = 292;
    pdaf_info->pd_block_num_y = 219;
    pdaf_info->pd_is_right = (cmr_u16 *)ov16885_normal_pd_is_right;
    pdaf_info->pd_pos_row = (cmr_u16 *)ov16885_normal_pd_row;
    pdaf_info->pd_pos_col = (cmr_u16 *)ov16885_normal_pd_col;
    cmr_u16 pd_pos_r_size = NUMBER_OF_ARRAY(_ov16885_normal_pd_pos_r);
    cmr_u16 pd_pos_l_size = NUMBER_OF_ARRAY(_ov16885_normal_pd_pos_l);
