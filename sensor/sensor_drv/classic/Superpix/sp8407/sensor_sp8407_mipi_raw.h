...
*
*/
#ifndef _SENSOR_SP8407_MIPI_RAW_H_
#define _SENSOR_SP8407_MIPI_RAW_H_
...
#include "parameters_front/sensor_sp8407_raw_param_main.c"
#include "sensor_sp8407_otp.h"
#else
...
// reduce maximum gain to half(8) to solve noise.
...
static const SENSOR_REG_T sp8407_init_setting1[] = {
    // lsy 20160616
    {0x0100, 0x00}, {0x031e, 0x0c}, {0x3000, 0x00}, {0x300e, 0x00},
    {0x3010, 0x00}, {0x3015, 0x84}, {0x3018, 0x32}, {0x3021, 0x23},
    {0x3033, 0x24}, {0x3500, 0x00}, {0x3503, 0x08}, {0x3505, 0x83},
    ...
    {0x3663, 0x08}, {0x3669, 0x34}, {0x3706, 0x86}, {0x370b, 0x7e},
    {0x3730, 0x12}, {0x3733, 0x10}, {0x3764, 0x00}, {0x3765, 0x00},
    {0x3769, 0x62}, {0x376a, 0x2a}, {0x376b, 0x30}, {0x3780, 0x00},
    {0x3781, 0x24}, {0x3782, 0x00}, {0x3783, 0x23}, {0x3798, 0x2f}, // add
    {0x37a1, 0x60}, {0x37a8, 0x6a}, {0x37ab, 0x3f}, {0x37c3, 0xf1},
    {0x37c9, 0x80}, {0x37cb, 0x03}, {0x37cc, 0x0a}, {0x37cd, 0x16},
    {0x37ce, 0x1f}, {0x3800, 0x00}, {0x3801, 0x00}, {0x3802, 0x00},
    {0x3803, 0x0c}, {0x3804, 0x0c}, {0x3805, 0xdf}, {0x3806, 0x09},
    {0x3807, 0xa3}, {0x3810, 0x00}, {0x3812, 0x00}, {0x3815, 0x01},
    {0x3816, 0x00}, {0x3817, 0x00}, {0x3818, 0x00}, {0x3819, 0x00},
    {0x382b, 0x01}, {0x3830, 0x06}, {0x3836, 0x02}, {0x3862, 0x04},
    {0x3863, 0x08}, {0x3cc0, 0x33}, {0x3d85, 0x17}, {0x3d8c, 0x73},
    {0x3d8d, 0xde}, {0x4001, 0xe0}, {0x4003, 0x40}, {0x4008, 0x00},
    {0x400a, 0x00}, {0x400b, 0x84}, {0x400f, 0x80}, {0x4010, 0xf0},
    {0x4011, 0xff}, {0x4012, 0x02}, // add
    {0x4013, 0x01},                 // add
    {0x4014, 0x01}, {0x4015, 0x01}, {0x4042, 0x00}, {0x4043, 0x80},
    {0x4044, 0x00}, {0x4045, 0x80}, {0x4046, 0x00}, {0x4047, 0x80},
    {0x4048, 0x00}, {0x4049, 0x80}, {0x4041, 0x03}, {0x404c, 0x20},
    {0x404d, 0x00}, {0x404e, 0x20}, {0x4203, 0x80}, {0x4307, 0x30},
    {0x4317, 0x00}, {0x4503, 0x08}, {0x4601, 0x80}, {0x4800, 0x44},
    {0x4816, 0x53}, {0x481b, 0x58}, {0x481f, 0x27}, {0x483c, 0x0f},
    {0x484b, 0x05}, {0x5000, 0x77}, {0x5001, 0x0a}, {0x5004, 0x04},
    {0x502e, 0x03}, {0x5030, 0x41}, {0x579a, 0x00}, {0x579c, 0x00},
    {0x5780, 0x14}, {0x5781, 0x0f}, {0x5782, 0x44}, {0x5783, 0x02},
    {0x5784, 0x01}, {0x5785, 0x01}, {0x5786, 0x00}, {0x5787, 0x04},
    {0x5788, 0x02}, {0x5789, 0x0f}, {0x578a, 0xfd}, {0x578b, 0xf5}, // add
    {0x578c, 0xf5},                                                 // add
    {0x578d, 0x03},                                                 // add
    {0x578e, 0x08}, {0x578f, 0x0c}, {0x5790, 0x08}, {0x5791, 0x04},
    {0x5792, 0x00}, {0x5793, 0x52}, {0x5794, 0xa3}, {0x59f8, 0x3d},
    {0x5a08, 0x02}, {0x5b00, 0x02}, {0x5b01, 0x10}, {0x5b02, 0x03},
    {0x5b03, 0xcf}, {0x5b05, 0x6c}, {0x5e00, 0x00},

};

static SENSOR_REG_T sp8407_preview_setting1[] = {
    // 1632 x1224 720Mbps 30fps 2lane lsy 20160616
    {0x0100, 0x00}, {0x0302, 0x3c}, {0x0303, 0x01}, {0x3501, 0x4c},
    {0x3502, 0xe0}, {0x366e, 0x08}, {0x3714, 0x27}, {0x37c2, 0x14},
    {0x3808, 0x06}, {0x3809, 0x60}, {0x380a, 0x04}, {0x380b, 0xc8},
    {0x380c, 0x0e}, {0x380d, 0xa0}, {0x380e, 0x04}, // 02
    {0x380f, 0xde}, {0x3811, 0x08}, {0x3813, 0x02}, // add
    {0x3814, 0x03},                                 // add
#if 1                                               // def IMAGE_NORMAL_MIRROR
    {0x3820, 0x96}, {0x3821, 0x61}, {0x382a, 0x03}, {0x4009, 0x05},
    ...
    {0x3820, 0xd0}, // flip
    {0x3821, 0x67}, {0x502e, 0x03}, {0x5001, 0x0a}, {0x5004, 0x04},
    {0x376b, 0x30},
#endif
    ...
    {0x579e, 0x06}, {0x579f, 0x20}, {0x57a0, 0x04}, {0x57a1, 0xa0},
    {0x3820, 0xd6}, // flip
    {0x3821, 0x61}, {0x502e, 0x00}, {0x5001, 0x0e}, {0x5004, 0x00},
    {0x376b, 0x36},
#endif
};
static const SENSOR_REG_T sp8407_preview_setting_front_flip[] = {
    // 1632 x1224 720Mbps 30fps 2lane lsy 20160616
    {0x0100, 0x00}, {0x0302, 0x3c}, {0x0303, 0x01}, {0x3501, 0x4c},
    {0x3502, 0xe0}, {0x366e, 0x08}, {0x3714, 0x27}, {0x37c2, 0x14},
    {0x3808, 0x06}, {0x3809, 0x60}, {0x380a, 0x04}, {0x380b, 0xc8},
...
static const SENSOR_REG_T sp8407_preview_setting_back_flip[] = {
    // 1632 x1224 720Mbps 30fps 2lane lsy 20160616
    {0x0100, 0x00}, {0x0302, 0x3c}, {0x0303, 0x01}, {0x3501, 0x4c},
    {0x3502, 0xe0}, {0x366e, 0x08}, {0x3714, 0x27}, {0x37c2, 0x14},
    {0x3808, 0x06}, {0x3809, 0x60}, {0x380a, 0x04}, {0x380b, 0xc8},
...
static const SENSOR_REG_T sp8407_snapshot_setting1[] = {
    ...
    {0x0100, 0x00}, {0x0302, 0x3c}, {0x0303, 0x01}, {0x3501, 0x9a},
    {0x3502, 0x20}, {0x366e, 0x10}, {0x3714, 0x23}, {0x37c2, 0x04},
    {0x3808, 0x0c}, {0x3809, 0xc0}, {0x380a, 0x09}, {0x380b, 0x90},
    {0x380c, 0x0f}, {0x380d, 0x20}, {0x380e, 0x09}, // 04
    {0x380f, 0xb2},                                 // 02
    {0x3811, 0x10}, {0x3813, 0x04},                 // add
    {0x3814, 0x01},                                 // add
#ifdef IMAGE_NORMAL_MIRROR
    {0x3820, 0x86}, {0x3821, 0x40}, {0x382a, 0x01}, {0x4009, 0x0b},
    {0x4837, 0x16}, {0x5795, 0x02}, {0x5796, 0x20}, {0x5797, 0x20},
    {0x5798, 0xd5}, {0x5799, 0xd5}, {0x579b, 0x50}, {0x579d, 0x2c},
    {0x579e, 0x0c}, {0x579f, 0x40}, {0x57a0, 0x09}, {0x57a1, 0x40},
    {0x3820, 0xc0}, // flip
    {0x3821, 0x46}, {0x502e, 0x03}, {0x5001, 0x0a}, {0x5004, 0x04},
    {0x376b, 0x30},
#endif
    ...
    {0x579e, 0x0c}, {0x579f, 0x40}, {0x57a0, 0x09}, {0x57a1, 0x40},
    {0x3820, 0xc6}, // flip
    {0x3821, 0x40}, {0x502e, 0x00}, {0x5001, 0x0e}, {0x5004, 0x00},
    {0x376b, 0x36},
#endif
};
...
#endif
// bps:1488,3264x2448,  30fps, frame_length 2482,line time:134
static SENSOR_REG_T sp8407_full_size_setting[] = {
    {0x0100, 0x00},
    {0x0302, 0x35},
    {0x0303, 0x00},
    {0x031e, 0x0c},
...
// bps:1488,3264x2448,  30fps, frame_length 2482,line time:134
static const SENSOR_REG_T sp8407_full_size_setting_back_flip[] = {
    {0x0100, 0x00},
    {0x0302, 0x35},
    {0x0303, 0x00},
    {0x031e, 0x0c},
...
// bps:1488,3264x2448,  30fps, frame_length 2482,line time:134
static SENSOR_REG_T sp8407_full_size_setting_front_flip[] = {
    {0x0100, 0x00},
    {0x0302, 0x35},
    {0x0303, 0x00},
    {0x031e, 0x0c},
...
static struct sensor_res_tab_info s_sp8407_resolution_tab_raw[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .reg_tab =
         {{ADDR_AND_LEN_OF_ARRAY(sp8407_init_setting1), PNULL, 0, .width = 0,
           .height = 0, .xclk_to_sensor = EX_MCLK,
           .image_format = SENSOR_IMAGE_FORMAT_RAW},

          {ADDR_AND_LEN_OF_ARRAY(sp8407_preview_setting1), PNULL, 0,
          ...
          {ADDR_AND_LEN_OF_ARRAY(sp8407_full_size_setting), PNULL, 0,
           .width = SNAPSHOT_WIDTH, .height = SNAPSHOT_HEIGHT,
           .xclk_to_sensor = EX_MCLK, .image_format = SENSOR_IMAGE_FORMAT_RAW}
...
static SENSOR_TRIM_T s_sp8407_resolution_trim_tab[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .trim_info =
         {
             ...
             /*{
              ...
              .line_time = SNAPSHOT_LINE_TIME,.bps_per_lane =
              SNAPSHOT_MIPI_PER_LANE_BPS,
              .frame_line = SNAPSHOT_FRAME_LENGTH,
              .scaler_trim = {.x = 0, .y = 0, .w = SNAPSHOT_TRIM_W, .h =
              SNAPSHOT_TRIM_H}},*/
             {.trim_start_x = 0,
              .trim_start_y = 0,
...
static const SENSOR_REG_T
    s_sp8407_preview_size_video_tab[SENSOR_VIDEO_MODE_MAX][1] = {
        /*video mode 0: ?fps */
        {{0xffff, 0xff}},
        /* video mode 1:?fps */
        {{0xffff, 0xff}},
...
static const SENSOR_REG_T
    s_sp8407_capture_size_video_tab[SENSOR_VIDEO_MODE_MAX][1] = {
        /*video mode 0: ?fps */
        {{0xffff, 0xff}},
        /* video mode 1:?fps */
        {{0xffff, 0xff}},
...
static SENSOR_STATIC_INFO_T s_sp8407_static_info[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .static_info = {.f_num = 220,
                     ...
                     .fov_info = {{3.678f, 2.768f}, 2.941f}}}
    /*If there are multiple modules,please add here*/
};

static SENSOR_MODE_FPS_INFO_T s_sp8407_mode_fps_info[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     {.is_init = 0,
...
static struct sensor_module_info s_sp8407_module_info_tab[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
...
SENSOR_INFO_T g_sp8407_mipi_raw_info = {
    ...
    .identify_count = 1,
    .identify_code = {{sp8407_PID_ADDR, sp8407_PID_VALUE},
    ...
    .resolution_tab_info_ptr = s_sp8407_resolution_tab_raw,
    .sns_ops = &s_sp8407_ops_tab,
    .raw_info_ptr = &s_sp8407_mipi_raw_info_ptr,
    .ext_info_ptr = NULL,

    .module_info_tab = s_sp8407_module_info_tab,
    .module_info_tab_size = ARRAY_SIZE(s_sp8407_module_info_tab),
    .video_tab_info_ptr = s_sp8407_video_info,

    .sensor_version_info = (cmr_s8 *)"sp8407_v1",
};
#endif
