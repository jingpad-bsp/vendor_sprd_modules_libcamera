...
#ifndef _SENSOR_GC02M1B_XL_MIPI_RAW_H_
#define _SENSOR_GC02M1B_XL_MIPI_RAW_H_
...
#define I2C_SLAVE_ADDR       0x20 	/*0x6e*//* 8bit slave address*/
...
static struct sensor_res_tab_info s_gc02m1b_resolution_tab_raw[VENDOR_NUM] = {
	{
      .module_id = MODULE_BOKEH_SLAVE_BACK,//MODULE_SUNNY,
      .reg_tab = {
