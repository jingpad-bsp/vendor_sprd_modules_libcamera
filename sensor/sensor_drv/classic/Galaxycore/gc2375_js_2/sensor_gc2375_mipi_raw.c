...
static void gc2375_drv_write_gain(cmr_handle handle,
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void gc2375_drv_write_frame_length(cmr_handle handle,
                                          struct sensor_aec_i2c_tag *aec_info,
                                          cmr_u32 frame_len) {
    SENSOR_IC_CHECK_PTR_VOID(aec_info);
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void gc2375_drv_write_shutter(cmr_handle handle,
                                     struct sensor_aec_i2c_tag *aec_info,
                                     cmr_u32 shutter) {
    SENSOR_IC_CHECK_PTR_VOID(aec_info);
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
...
static cmr_int gc2375_drv_read_aec_info(cmr_handle handle, cmr_uint param) {
    ...
    gc2375_drv_calc_exposure(handle, exposure_line, dummy_line, mode,
                             &gc2375_aec_info);
...
static cmr_int gc2375_drv_set_master_FrameSync(cmr_handle handle,
                                               cmr_uint param) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
gc2375_drv_handle_create(struct sensor_ic_drv_init_para *init_param,
    ...
    gc2375_drv_write_frame_length(
        sns_drv_cxt, &gc2375_aec_info,
        sns_drv_cxt->sensor_ev_info.preview_framelength);
    gc2375_drv_write_gain(sns_drv_cxt, &gc2375_aec_info,
                          sns_drv_cxt->sensor_ev_info.preview_gain);
    gc2375_drv_write_shutter(sns_drv_cxt, &gc2375_aec_info,
                             sns_drv_cxt->sensor_ev_info.preview_shutter);
...
void *sensor_ic_open_lib(void) { return &g_gc2375_mipi_raw_info; }
