...
*
*/
#ifndef _SENSOR_hi846_front_MIPI_RAW_H_
#define _SENSOR_hi846_front_MIPI_RAW_H_
...
#define VENDOR_NUM 1
#define SENSOR_NAME "hi846_front_mipi_raw"
...
#define hi846_front_PID_ADDR 0x0F17
#define hi846_front_PID_VALUE 0x08
#define hi846_front_VER_ADDR 0x0F16
#define hi846_front_VER_VALUE 0x46
...
static const SENSOR_REG_T hi846_front_init_setting[] = {
    // Sensor Information////////////////////////////
    // Sensor	  : Hi-846
    // Date		  : 2017-01-25
...
static const SENSOR_REG_T hi846_front_preview_setting[] = {
    // Sensor Information////////////////////////////
    // Sensor	  : Hi-846
    // Date		  : 2017-01-25
    // Customer        : SPRD_validation
...
static const SENSOR_REG_T hi846_front_snapshot_setting[] = {
    // Sensor Information////////////////////////////
    // Sensor	  : Hi-846
    // Date		  : 2017-01-25
    // Customer        : SPRD_validation
...
static const SENSOR_REG_T hi846_front_video_setting[] = {
    // Sensor Information////////////////////////////
    // Sensor	  : Hi-846
    // Date		  : 2017-01-25
    // Customer        : SPRD_validation
...
static struct sensor_res_tab_info s_hi846_front_resolution_tab_raw[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .reg_tab =
         {{ADDR_AND_LEN_OF_ARRAY(hi846_front_init_setting), PNULL, 0, .width = 0,
           .height = 0, .xclk_to_sensor = EX_MCLK,
           .image_format = SENSOR_IMAGE_FORMAT_RAW},

          {ADDR_AND_LEN_OF_ARRAY(hi846_front_video_setting), PNULL, 0,
           .width = VIDEO_WIDTH, .height = VIDEO_HEIGHT,
           .xclk_to_sensor = EX_MCLK, .image_format = SENSOR_IMAGE_FORMAT_RAW},

          {ADDR_AND_LEN_OF_ARRAY(hi846_front_preview_setting), PNULL, 0,
           .width = PREVIEW_WIDTH, .height = PREVIEW_HEIGHT,
           .xclk_to_sensor = EX_MCLK, .image_format = SENSOR_IMAGE_FORMAT_RAW},

          {ADDR_AND_LEN_OF_ARRAY(hi846_front_snapshot_setting), PNULL, 0,
...
static SENSOR_TRIM_T s_hi846_front_resolution_trim_tab[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .trim_info =
         {
...
static SENSOR_REG_T hi846_front_shutter_reg[] = {
    {0x0074, 0x0000},
};

static struct sensor_i2c_reg_tab hi846_front_shutter_tab = {
    .settings = hi846_front_shutter_reg, .size = ARRAY_SIZE(hi846_front_shutter_reg),
};

static SENSOR_REG_T hi846_front_again_reg[] = {
    {0x0076, 0x0000},
};

static struct sensor_i2c_reg_tab hi846_front_again_tab = {
    .settings = hi846_front_again_reg, .size = ARRAY_SIZE(hi846_front_again_reg),
};

static SENSOR_REG_T hi846_front_dgain_reg[] = {

};

static struct sensor_i2c_reg_tab hi846_front_dgain_tab = {
    .settings = hi846_front_dgain_reg, .size = ARRAY_SIZE(hi846_front_dgain_reg),
};

static SENSOR_REG_T hi846_front_frame_length_reg[] = {
    {0x0006, 0x0000},
};

static struct sensor_i2c_reg_tab hi846_front_frame_length_tab = {
    .settings = hi846_front_frame_length_reg,
    .size = ARRAY_SIZE(hi846_front_frame_length_reg),
};

static struct sensor_aec_i2c_tag hi846_front_aec_info = {
    .slave_addr = (I2C_SLAVE_ADDR >> 1),
    .addr_bits_type = SENSOR_I2C_REG_16BIT,
    .data_bits_type = SENSOR_I2C_VAL_16BIT,
    .shutter = &hi846_front_shutter_tab,
    .again = &hi846_front_again_tab,
    .dgain = &hi846_front_dgain_tab,
    .frame_length = &hi846_front_frame_length_tab,
};

static SENSOR_STATIC_INFO_T s_hi846_front_static_info[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .static_info = {.f_num = 200,
                     ...
                     .fov_info = {{4.614f, 3.444f}, 3.993f}}}
    /*If there are multiple modules,please add here*/
};

static SENSOR_MODE_FPS_INFO_T s_hi846_front_mode_fps_info[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     {.is_init = 0,
...
static struct sensor_module_info s_hi846_front_module_info_tab[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
...
struct sensor_raw_info *s_hi846_front_mipi_raw_info_ptr = PNULL;
 ...
 *============================================================================*/
SENSOR_INFO_T g_hi846_front_mipi_raw_info = {
    ...
    .identify_count = 1,
    .identify_code = {{.reg_addr = hi846_front_PID_ADDR,
                       .reg_value = hi846_front_PID_VALUE},
                      {.reg_addr = hi846_front_VER_ADDR,
                       .reg_value = hi846_front_VER_VALUE}},
    ...
    .module_info_tab = s_hi846_front_module_info_tab,
    .module_info_tab_size = ARRAY_SIZE(s_hi846_front_module_info_tab),

    .resolution_tab_info_ptr = s_hi846_front_resolution_tab_raw,
    .sns_ops = &s_hi846_front_ops_tab,
    .raw_info_ptr = &s_hi846_front_mipi_raw_info_ptr,

    .video_tab_info_ptr = NULL,
    .sensor_version_info = (cmr_s8 *)"hi846_front_v1",
};
