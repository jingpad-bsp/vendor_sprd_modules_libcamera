...
#define LOG_TAG "sensor_imx362"
#include "sensor_imx362_mipi_raw.h"

#define VIDEO_INFO s_imx362_video_info
#define STATIC_INFO s_imx362_static_info
#define FPS_INFO s_imx362_mode_fps_info
#define RES_TAB_RAW s_imx362_resolution_tab_raw
#define RES_TRIM_TAB s_imx362_resolution_trim_tab
#define MIPI_RAW_INFO g_imx362_mipi_raw_info
#define MODULE_INFO s_imx362_module_info_tab
 ...
 *
 *============================================================================*/
static cmr_int imx362_drv_set_video_mode(cmr_handle handle, cmr_u32 param) {
 ...
 *
 *============================================================================*/
static cmr_u32 imx362_drv_get_default_frame_length(cmr_handle handle,
                                                cmr_u32 mode) {
 ...
 *============================================================================*/
static void imx362_drv_group_hold_on(cmr_handle handle) { UNUSED(handle); }
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void imx362_drv_group_hold_off(cmr_handle handle) { UNUSED(handle); }
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u16 imx362_drv_read_gain(cmr_handle handle) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void imx362_drv_write_gain(cmr_handle handle, float gain) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u16 imx362_drv_read_frame_length(cmr_handle handle) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void imx362_drv_write_frame_length(cmr_handle handle,
                                          cmr_u32 frame_len) {
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u32 imx362_drv_read_shutter(cmr_handle handle) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void imx362_drv_write_shutter(cmr_handle handle, cmr_u32 shutter) {
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 *============================================================================*/
static cmr_u16 imx362_drv_update_exposure(cmr_handle handle, cmr_u32 shutter,
                                          cmr_u32 dummy_line) {
    ...
    cur_fr_len = imx362_drv_read_frame_length(handle);

    if (shutter < SENSOR_MIN_SHUTTER)
        shutter = SENSOR_MIN_SHUTTER;

    if (dest_fr_len != cur_fr_len)
        imx362_drv_write_frame_length(handle, dest_fr_len);
write_sensor_shutter:
    /* write shutter to sensor registers */
    imx362_drv_write_shutter(handle, shutter);
    return shutter;
}
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int imx362_drv_power_on(cmr_handle handle, cmr_uint power_on) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int imx362_drv_init_fps_info(cmr_handle handle) {
    cmr_int ret = SENSOR_SUCCESS;
    ...
    if (!fps_info->is_init) {
        ...
        SENSOR_LOGI("imx362_init_mode_fps_info:start init");
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int imx362_drv_identify(cmr_handle handle, cmr_uint param) {
    ...
    SENSOR_LOGI("imx362 mipi raw identify");

    pid_value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, imx362_PID_ADDR);
    ...
    if (imx362_PID_VALUE == pid_value || 0x2 == pid_value) {
        ...
        if (imx362_VER_VALUE == ver_value) {
            ...
            SENSOR_LOGI("this is imx362 sensor");
            imx362_drv_init_fps_info(handle);
        } else {
 ...
 *
 *============================================================================*/
static cmr_uint imx362_drv_get_trim_tab(cmr_handle handle, cmr_uint param) {
    UNUSED(param);
    UNUSED(handle);
 ...
 *============================================================================*/
static cmr_int imx362_drv_before_snapshot(cmr_handle handle, cmr_uint param) {
    ...
    cap_shutter = imx362_drv_update_exposure(handle, cap_shutter, 0);
    cap_gain = gain;
    imx362_drv_write_gain(handle, cap_gain);
 ...
 *============================================================================*/
static cmr_int imx362_drv_write_exposure(cmr_handle handle, cmr_uint param) {
    ...
    sns_drv_cxt->sensor_ev_info.preview_shutter =
        imx362_drv_update_exposure(handle, exposure_line, dummy_line);
    if (sns_drv_cxt->ops_cb.set_exif_info) {
        sns_drv_cxt->ops_cb.set_exif_info(sns_drv_cxt->caller_handle,
                                          SENSOR_EXIF_CTRL_EXPOSURETIME,
                                          exposure_line);
...
static cmr_int imx362_drv_ex_write_exposure(cmr_handle handle, cmr_uint param) {
    cmr_int ret_value = SENSOR_SUCCESS;
    cmr_u16 exposure_line = 0x00;
    cmr_u16 dummy_line = 0x00;
    cmr_u16 mode = 0x00;
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int imx362_drv_write_gain_value(cmr_handle handle, cmr_uint param) {
    float real_gain = 0;
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    ...
    imx362_drv_write_gain(handle, real_gain);
 ...
 *
 *============================================================================*/
static void imx362_drv_increase_hdr_exposure(cmr_handle handle,
 ...
 *
 *============================================================================*/
static void imx362_drv_decrease_hdr_exposure(cmr_handle handle,
                                             cmr_u8 ev_divisor) {
    ...
    if (gain_multiply >= ev_divisor) {
        imx362_drv_update_exposure(handle, hdr_info->capture_shutter, 0);
        imx362_drv_write_gain(handle, hdr_info->capture_gain / ev_divisor);

    } else {
        shutter = hdr_info->capture_shutter * gain_multiply / ev_divisor;
        imx362_drv_update_exposure(handle, shutter, 0);
        imx362_drv_write_gain(handle, hdr_info->capture_gain / gain_multiply);
    }
}
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int imx362_drv_set_hdr_ev(cmr_handle handle, cmr_uint param) {
    cmr_int ret = SENSOR_SUCCESS;
    ...
    case SENSOR_HDR_EV_LEVE_0:
        ev_divisor = 2;
        imx362_drv_decrease_hdr_exposure(handle, ev_divisor);
        break;
    case SENSOR_HDR_EV_LEVE_1:
        ev_multiplier = 2;
        imx362_drv_increase_hdr_exposure(handle, ev_multiplier);
        break;
 ...
 *sensor_drv_u.h
 *============================================================================*/
static cmr_int imx362_drv_ext_func(cmr_handle handle, cmr_uint param) {
    ...
    switch (ext_ptr->cmd) {
    case SENSOR_EXT_EV:
        rtn = imx362_drv_set_hdr_ev(handle, param);
        break;
    default:
        break;
    }
...
cmr_int imx362_drv_write_spcdata(cmr_handle handle, cmr_u8 *param) {
    SENSOR_IC_CHECK_HANDLE(handle);
    SENSOR_LOGI("E");
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int imx362_drv_set_pdaf_mode(cmr_handle handle, cmr_uint param) {
    UNUSED(param);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int imx362_drv_stream_on(cmr_handle handle, cmr_uint param) {
    UNUSED(param);
...
/*   if(sensor_mode == 3)
       imx362_drv_set_pdaf_mode(handle, 0x31);
   else if(sensor_mode == 2)
       imx362_drv_set_pdaf_mode(handle, 0x21);
   //imx362_drv_set_pdaf_mode(handle, 1);
*/
#if 1
...
static cmr_int imx362_drv_get_static_info(cmr_handle handle, cmr_u32 *param) {
    cmr_int rtn = SENSOR_SUCCESS;
...
static cmr_int imx362_drv_get_fps_info(cmr_handle handle, cmr_u32 *param) {
    cmr_int rtn = SENSOR_SUCCESS;
...
static const cmr_u16 imx362_pd_is_right[] = {0, 0, 1, 1, 1, 1, 0, 0};

static const cmr_u16 imx362_pd_row[] = {5, 5, 8, 8, 21, 21, 24, 24};

static const cmr_u16 imx362_pd_col[] = {2, 18, 1, 17, 10, 26, 9, 25};
static const struct pd_pos_info _imx362_pd_pos_l[] = {
    {2, 5}, {18, 5}, {9, 24}, {25, 24},
};
...
static cmr_int imx362_drv_get_pdaf_info(cmr_handle handle, cmr_u32 *param) {
    ...
    pd_pos_is_right_size = NUMBER_OF_ARRAY(imx362_pd_is_right);
    pd_pos_row_size = NUMBER_OF_ARRAY(imx362_pd_row);
    pd_pos_col_size = NUMBER_OF_ARRAY(imx362_pd_col);
    ...
    pdaf_info->pd_is_right = (cmr_u16 *)imx362_pd_is_right;
    pdaf_info->pd_pos_row = (cmr_u16 *)imx362_pd_row;
    pdaf_info->pd_pos_col = (cmr_u16 *)imx362_pd_col;

    cmr_u16 pd_pos_r_size = NUMBER_OF_ARRAY(_imx362_pd_pos_r);
    cmr_u16 pd_pos_l_size = NUMBER_OF_ARRAY(_imx362_pd_pos_l);
...
static cmr_int imx362_drv_set_spc_data(cmr_handle handle, cmr_u8 *param) {
    cmr_int rtn = SENSOR_SUCCESS;
    cmr_u8 *spc_data = (cmr_u8 *)param;
    SENSOR_LOGI("*param 0x%x 0x%x", *param, *spc_data);

    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    imx362_drv_write_spcdata(handle, spc_data);

    return rtn;
}

static cmr_int imx362_drv_access_val(cmr_handle handle, cmr_uint param) {
    cmr_int rtn = SENSOR_SUCCESS;
    ...
    case SENSOR_VAL_TYPE_GET_STATIC_INFO:
        rtn = imx362_drv_get_static_info(handle, param_ptr->pval);
        break;
    case SENSOR_VAL_TYPE_GET_FPS_INFO:
        rtn = imx362_drv_get_fps_info(handle, param_ptr->pval);
        break;
...
static cmr_u16 imx362_drv_calc_exposure(cmr_handle handle, cmr_u32 shutter,
                                        cmr_u32 dummy_line,
...
static void imx362_drv_calc_gain(float gain,
                                 struct sensor_aec_i2c_tag *aec_info) {
    uint8_t i = 0;
    cmr_u32 sensor_again = 0;
    cmr_u32 sensor_dgain = 0;
...
static unsigned long imx362_drv_read_aec_info(cmr_handle handle,
                                              cmr_uint param) {
    ...
    info->aec_i2c_info_out = &imx362_aec_info;
    ...
    sns_drv_cxt->sensor_ev_info.preview_shutter = imx362_drv_calc_exposure(
        handle, exposure_line, dummy_line, &imx362_aec_info);

    gain = info->gain < SENSOR_BASE_GAIN ? SENSOR_BASE_GAIN : info->gain;
    real_gain = (float)info->gain * SENSOR_BASE_GAIN / ISP_BASE_GAIN * 1.0;
    imx362_drv_calc_gain(real_gain, &imx362_aec_info);
#endif
...
static cmr_int
imx362_drv_handle_create(struct sensor_ic_drv_init_para *init_param,
...
static cmr_int imx362_drv_handle_delete(cmr_handle handle, void *param) {
    cmr_int ret = SENSOR_SUCCESS;
...
static cmr_int imx362_drv_get_private_data(cmr_handle handle, cmr_uint cmd,
                                           void **param) {
    cmr_int ret = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
    SENSOR_IC_CHECK_PTR(param);
...
static struct sensor_ic_ops s_imx362_ops_tab = {
    .create_handle = imx362_drv_handle_create,
    .delete_handle = imx362_drv_handle_delete,
    /*get privage data*/
    .get_data = imx362_drv_get_private_data,
    /*common interface*/
    .power = imx362_drv_power_on,
    .identify = imx362_drv_identify,
    .write_gain_value = imx362_drv_write_gain_value,
    .read_aec_info = imx362_drv_read_aec_info,
    .ex_write_exp = imx362_drv_ex_write_exposure,
    .ext_ops = {
            [SENSOR_IOCTL_BEFORE_SNAPSHOT].ops = imx362_drv_before_snapshot,
            [SENSOR_IOCTL_STREAM_ON].ops = imx362_drv_stream_on,
            [SENSOR_IOCTL_STREAM_OFF].ops = imx362_drv_stream_off,
            [SENSOR_IOCTL_ACCESS_VAL].ops = imx362_drv_access_val,
    }};
