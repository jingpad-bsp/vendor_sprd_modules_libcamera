 ...
 */
#define LOG_TAG "isp_blk_rgb_ltm"
#include "isp_blocks_cfg.h"

cmr_s32 _pm_rgb_ltm_init(void *dst_rgb_ltm_param, void *src_rgb_ltm_param, void *param1, void *param2)
{
	cmr_u32 i = 0;
	cmr_u32 index = 0;
	cmr_s32 rtn = ISP_SUCCESS;
	struct isp_rgb_ltm_param *dst_ptr = (struct isp_rgb_ltm_param *)dst_rgb_ltm_param;
	struct sensor_rgb_ltm_param *src_ptr = (struct sensor_rgb_ltm_param *)src_rgb_ltm_param;
	...
	if (!ltm_header_ptr->bypass){
		for ( i = 0; i < SENSOR_YUV_LTM_NUM; i++) {
			dst_ptr->ltm_param[i].ltm_map_bypass = src_ptr->rgb_ltm_param[i].rgb_ltm_map.bypass;
			dst_ptr->ltm_param[i].ltm_map_video_mode = src_ptr->rgb_ltm_param[i].rgb_ltm_map.ltm_map_video_mode;

			dst_ptr->ltm_param[i].ltm_stat_bypass = src_ptr->rgb_ltm_param[i].rgb_ltm_stat.bypass;
			dst_ptr->ltm_param[i].ltm_stat_strength = src_ptr->rgb_ltm_param[i].rgb_ltm_stat.strength;
			dst_ptr->ltm_param[i].tile_num_auto = src_ptr->rgb_ltm_param[i].rgb_ltm_stat.tile_num_auto;
			dst_ptr->ltm_param[i].region_est_en = src_ptr->rgb_ltm_param[i].rgb_ltm_stat.region_est_en;
			dst_ptr->ltm_param[i].channel_sel = src_ptr->rgb_ltm_param[i].rgb_ltm_stat.channel_sel;
			dst_ptr->ltm_param[i].tile_num_x = src_ptr->rgb_ltm_param[i].rgb_ltm_stat.tile_num.tile_num_x;
			dst_ptr->ltm_param[i].tile_num_y = src_ptr->rgb_ltm_param[i].rgb_ltm_stat.tile_num.tile_num_y;
...
{
	cmr_s32 rtn = ISP_SUCCESS;
	struct isp_rgb_ltm_param *dst_ptr = (struct isp_rgb_ltm_param *)rgb_ltm_param;
...
{
	cmr_s32 rtn = ISP_SUCCESS;
	struct isp_rgb_ltm_param *ltm_ptr = (struct isp_rgb_ltm_param *)rgb_ltm_param;
