...
cmr_s32 _pm_posterize_init(void *dst_pstrz_param, void *src_pstrz_param, void *param1, void *param_ptr2)
{
	...
	dst_pstrz_ptr->cur_v0.bypass = pstrz_header_ptr->bypass;

	memcpy(&dst_pstrz_ptr->cur_v0.posterize_level_bottom[0], &src_pstrz_ptr->pstrz_bot[0], sizeof(src_pstrz_ptr->pstrz_bot));
	memcpy(&dst_pstrz_ptr->cur_v0.posterize_level_top[0], &src_pstrz_ptr->pstrz_top[0], sizeof(src_pstrz_ptr->pstrz_top));
	memcpy(&dst_pstrz_ptr->cur_v0.posterize_level_out[0], &src_pstrz_ptr->pstrz_out[0], sizeof(src_pstrz_ptr->pstrz_out));
...
cmr_s32 _pm_posterize_set_param(void *pstrz_param, cmr_u32 cmd, void *param_ptr0, void *param_ptr1)
{
	...
	case ISP_PM_BLK_PSTRZ_BYPASS:
		pstrz_ptr->cur_v0.bypass = *((cmr_u32 *) param_ptr0);
		break;
...
cmr_s32 _pm_posterize_get_param(void *pstrz_param, cmr_u32 cmd, void *rtn_param0, void *rtn_param1)
{
	...
	case ISP_PM_BLK_ISP_SETTING:
		param_data_ptr->data_ptr = &pstrz_ptr->cur_v0;
		param_data_ptr->data_size = sizeof(pstrz_ptr->cur_v0);
		*update_flag = 0;
		break;
