...
#define ISP_NR_HDR_MODE_BIT (0x01 << ISP_SCENEMODE_HDR)
#define ISP_NR_7_MODE_BIT (0x01 << 7)
#define ISP_NR_8_MODE_BIT (0x01 << 8)
#define ISP_NR_9_MODE_BIT (0x01 << 9)
#define ISP_NR_10_MODE_BIT (0x01 << 10)
#define ISP_NR_11_MODE_BIT (0x01 << 11)
...
cmr_u8 nr_tool_flags[ISP_BLK_NR_MAX] = { 0 };
