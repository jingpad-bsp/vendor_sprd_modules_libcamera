...
AE_PUBLIC cmr_s32 ae_debug_packet(cmr_handle input, cmr_handle output);/*according to the debug structure, save the debug infomation*/
AE_PUBLIC cmr_s32 ae_debug_unpacket(cmr_handle input, cmr_handle output);/*parser the debug information to debug structure*/
AE_PUBLIC cmr_s32 ae_debug_print(cmr_handle input, cmr_handle output);
AE_PUBLIC cmr_s32 ae_debug_draw(cmr_handle input, cmr_handle output);
AE_PUBLIC cmr_handle ae_debug_get_lib_version(void);
AE_PUBLIC cmr_s32 ae_debug_get_alg_version(cmr_handle debug_info, cmr_handle major_id, cmr_handle minor_id);
