...
extern "C" {
	...
	cmr_handle s_q_open_v0(struct s_q_open_param *param);
	cmr_s32 s_q_init_v0(cmr_handle q_handle, struct s_q_init_in *in, struct s_q_init_out *out);
	cmr_s32 s_q_put_v0(cmr_handle q_handle, struct q_item *input_item, struct q_item *write_2_sensor, struct q_item *actual_item);
	cmr_s32 s_q_close_v0(cmr_handle q_handle);
