 ...
 */
int sprd_dre_init(void **handle, int max_width, int max_height, void *init_param);
...
int sprd_dre_run(void *handle, sprd_camalg_image_t *input, void *param);
 ...
 * - handle: [in] the handle pointer.
 */
void sprd_dre_fast_stop(void *handle);
 ...
 * @return: 0 is success, other is failure.
 */
int sprd_dre_deinit(void **handle);
